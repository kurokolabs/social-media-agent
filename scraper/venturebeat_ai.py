"""VentureBeat AI scraper — for Instagram and X content."""
from scraper.base_scraper import BaseScraper
from config import MAX_ARTICLE_WORDS


class VentureBeatAIScraper(BaseScraper):
    SOURCE = "venturebeat_ai"
    _URL = "https://venturebeat.com/ai/"
    _RSS = "https://venturebeat.com/ai/feed/"
